...
function page() {
  return (
    <div >
<h1 className="font-semibold text-2xl mt-24 mb-4 text-center ml-12">
  Privacy Policy
</h1>
<hr className="border-t-2 border-black ml-6 w-[95%] mb-10" />

<h2 className=" text-xl font-bold ml-12 mb-2">
Introduction
</h2>
<p className="text-lg text-black ml-12 mb-6">
This Privacy Policy describes how INEPTIA EDTECH LLP INEPTIA
and its affiliates (collectively "
EDTECH LLP
, we, our, us") collect, use, share, protect or otherwise process your information/ personal
data through our website https://truskill.in/courses Platform
(hereinafter referred to as ). Please note
that you may be able to browse certain sections of the Platform without registering with us.We do not
offer any product/service under this Platform outside India and your personal data will primarily be
...
to be governed by the laws of India including but not limited to the laws applicable to data protection and
...
any information. If you receive an email, a call from a person/association claiming to be INEPTIA
EDTECH LLP
