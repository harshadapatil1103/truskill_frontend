...
const [whatsapp,setWhatsapp]=useState("https://www.facebook.com")
    ...
    const fetchCourseData = async () => {
      try {
        const response = await fetch(
          `https://strapi.truskill.in/api/course-pages/${slug}?populate=*`
        );
  ...
  return (
    <section className="lg:mx-44 mx-3 mb-10">
        ...
        <div className="lg:flex lg:justify-between">
          ...
          <img
            src={`https://strapi.truskill.in${course.image.formats.thumbnail.url}`}
  ...
  <div className="mb-4">
    <video
      src={`https://strapi.truskill.in${course.video_preview.url}`}
      className="w-full p-3"
      controls
      alt={course.title}
    >
