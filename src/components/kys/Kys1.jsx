...
<div className="w-full lg:w-1/2 p-5 bg-white">
  <p className="text-[#3B9B72] text-[14px] md:text-[16px]">
  Unlock Your Hidden Potential
  </p>
  <h2 className="text-[40px] md:text-5xl font-semibold my-6 font-poppins">Benchmark Yourself Against Top Professionals.</h2>
  ...
  <Link href="*" className=" px-2 py-2  md:px-4 md:py-2 bg-[#0B5E41] text-white rounded-full mb-8 md:mb-0 text-[16px]">Test Yourself Now</Link>
