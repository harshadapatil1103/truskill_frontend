export default function MockInterview() {
  ...
  <li className="flex items-center gap-2">
    <img src="/images/about/checkbox.png" className="w-5 h-5 text-[#006241] border-gray-300" />
    <span className="text-[#006241]">Receive instant feedback and ratings on your answers and overall performance.</span>
  </li>
  <li className="flex items-center gap-2">
    <img src="/images/about/checkbox.png" className="w-5 h-5 text-[#006241] border-gray-300" />
    <span className="text-[#006241]">Practice with a diverse range of interviews.</span>
  </li>
</ul>
        ...
        <div className="relative flex flex-col items-center md:order-first">
          ...
          <p className="text-green-400 text-sm italic mt-10">
            "-unknown"
          </p>
          </div>
        </div>
