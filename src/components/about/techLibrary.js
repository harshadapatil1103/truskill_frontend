...
export default function TechLibrary() {
    return (
      <div className="bg-[#FFFFFF] px-8 py-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          {/* Left Section */}
          <div>
            <h1 className="text-[24px] md:text-3xl font-semibold mb-4 text-gray-900">TECH POWERED RESOURCE LIBRARY</h1>
  ...
  <li className="flex items-center gap-2">
    ...
    <span className="text-[#3b9b72]">2000+ exam paper analysis.</span>
  </li>
  <li className="flex items-center gap-2">
    <img src="/images/about/checkbox.png" className="w-5 h-5 text-[#3b9b72] border-gray-300" />
    <span className="text-[#3b9b72]">High-yield learning strategy.</span>
  </li>
  <li className="flex items-center gap-2">
    <img src="/images/about/checkbox.png" className="w-5 h-5 text-[#3b9b72] border-gray-300" />
    <span className="text-[#3b9b72]">Precision study resources.</span>
  </li>
  <li className="flex items-center gap-2">
    <img src="/images/about/checkbox.png" className="w-5 h-5 text-[#3b9b72] border-gray-300" />
    <span className="text-[#3b9b72]">Technology-enabled learning.</span>
  </li>
  <li className="flex items-center gap-2">
    <img src="/images/about/checkbox.png" className="w-5 h-5 text-[#3b9b72] border-gray-300" />
    <span className="text-[#3b9b72]">Focused exam preparation.</span>
  </li>
</ul>
