...
const CollegeAssistanceModule = () => {
    ...
    <div className="bg-[#FFFFFF] px-4 py-8 md:px-8 md:py-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
        ...
        <div className="space-y-6 md:ml-8"> {/* Increased left margin on larger screens */}
          <h1 className="text-[24px] md:text-3xl md:text-3xl  font-semibold text-gray-900 mb-6 tracking-wide">
            COLLEGE ASSISTANCE MODULE (FOR INSTITUTE USE)
          </h1>
          <p className="text-sm text-[#3b9b72] mb-6 text-justify">
            Fact-Institutions using data-driven analytics see a 45% increase in student success rates.
          </p>

          <p className="text-gray-700 mb-8 leading-relaxed text-sm text-justify">
  ...
  <li className="flex items-center gap-2">
    ...
    <span className="text-[#3b9b72]">Generate individual student reports that include detailed performance data.</span>
  </li>
  <li className="flex items-center gap-2">
    <img src="/images/about/checkbox.png" className="w-5 h-5 text-[#3b9b72] border-gray-300 " />
    <span className="text-[#3b9b72]">Analyze the overall performance of the class across various test series.</span>
  </li>
  <li className="flex items-center gap-2">
    <img src="/images/about/checkbox.png" className="w-5 h-5 text-[#3b9b72] border-gray-300 " />
    <span className="text-[#3b9b72]">Create thorough college-wide reports with just one click.</span>
  </li>
  <li className="flex items-center gap-2">
    <img src="/images/about/checkbox.png" className="w-5 h-5 text-[#3b9b72] border-gray-300 " />
    <span className="text-[#3b9b72]">Efficiently assign students to different batches and make adjustments based on their performance.</span>
  </li>
  <li className="flex items-center gap-2">
    <img src="/images/about/checkbox.png" className="w-5 h-5 text-[#3b9b72] border-gray-300 " />
    <span className="text-[#3b9b72]">Simplify student management tasks to enhance efficiency.</span>
  </li>
</ul>
        ...
        <div className="flex justify-center items-center md:mr-4"> {/* Reduced right margin */}
          <Card className="overflow-hidden max-w-md  border-0">
            <img 
