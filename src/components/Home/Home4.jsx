  ...
  return (
    <div className="mt-10 flex flex-col lg:flex-row justify-center items-center space-y-6 lg:space-y-0 lg:space-x-10">
      ...
      <div>
        <img
          src="/Home/Line1.png"
          alt="Dotted Maze With Green Path Illustration"
      ...
      <div className="flex flex-col items-center w-full max-w-md px-6  rounded-lg space-y-10">
        ...
        <img
          src="/Home/Home3.png"
          alt="Pyramid illustration showing Steps from Learning to Mastering a Skill"
          className="w-4/5 h-auto mb-4 rounded-lg"
        />
        <ol className="list-disc pl-5 space-y-2 text-black text-[22px]">
          <li>Structured learning plans tailored for your growth</li>
          <li>
            A reliable source for all the skills you want to learn and benefit
            from
          </li>
