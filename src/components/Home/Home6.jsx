  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center text-center px-6 mt-20">
        <p className="text-base md:text-lg text-[#A7A7A7] uppercase ">
      ...
      <div>
        ...
        <div className='flex flex-row'>
          <div className='mt-40'>
            ...
            <img src="/Home/Line3.png" alt="Without Truskill" />
          </div>  
            ...
            <div className="flex flex-col md:flex-row items-center h-auto py-5">
              <div className="lg:flex w-full lg:w-1/2 items-center lg:space-x-7 lg:space-y-5">
                <div className="md:text-left">
                  ...
                  <h4 className="text-xl md:text-[22px] lg:text-[38px] font-medium mb-3">
                    your own pace with 
                  </h4>
                  <h4 className="text-xl md:text-[22px] lg:text-[38px] font-medium mb-6">
                   customized plans
